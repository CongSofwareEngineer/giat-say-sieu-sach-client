      ...
      <div className='max-w-3xl mx-auto'>
        ...
        <div className='mt-12 pt-8 border-t border-border'>
          ...
          <div className='flex gap-3'>
            <button className='px-4 py-2 bg-blue-500 text-white rounded-lg transition-colors'>Facebook</button>
            <button className='px-4 py-2 bg-green-500 text-white rounded-lg transition-colors'>Zalo</button>
          </div>
        </div>

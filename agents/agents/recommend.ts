...
import { baseTools, getBranchesTool, getContactInfoTool, openLaundryFormTool, trackOrderTool } from '../tools'
...
Reply in the user's language (use answer_in_language if unsure).`,
  tools: [...baseTools, trackOrderTool, getContactInfoTool, getBranchesTool, openLaundryFormTool],
}
